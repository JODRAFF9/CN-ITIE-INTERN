# =============================================================================
# OpenRBE - Module Réseau — Zoom automatique sur nœud sélectionné
# ITIE Sénégal - modules/network_module.R  v1.2
# =============================================================================
      ...
      shiny::column(12,
        shiny::div(class = "chart-card",
          ...
          shiny::div(class = "network-legend",
            shiny::span(class = "legend-dot legend-company"), " Entreprise  ",
            shiny::span(class = "legend-dot legend-ben"),     " Bénéficiaire"
          ),
          ...
          shiny::div(class = "network-info",
            ...
            " Cliquez sur un noeud pour zoomer et voir ses connexions.",
...
networkServer <- function(id, filtered_data) {
  shiny::moduleServer(id, function(input, output, session) {
      ...
      visNetwork::visNetwork(nodes = nd$nodes, edges = nd$edges, width = "100%") |>
        visNetwork::visOptions(
          ...
          nodesIdSelection = list(
            ...
            style   = paste0("width:220px;font-size:13px;",
        ...
        visNetwork::visGroups(
          ...
          color     = list(
            background = "#008C45", border = "#005A2E",
        ...
        visNetwork::visGroups(
          ...
          color     = list(
            background = "#F4C300", border = "#B89300",
        ...
        visNetwork::visLegend(useGroups = TRUE, position = "right", width = 0.14) |>
        visNetwork::visEvents(
          selectNode = "function(params) {
            if (params.nodes.length > 0) {
              ...
              Shiny.setInputValue('network-selected_node', nodeId, {priority: 'event'});
            }
          }",
          deselectNode = "function(params) {
            Shiny.setInputValue('network-selected_node', null, {priority: 'event'});
          }"
        ) |>
        visNetwork::visExport(
          ...
          name  = "openrbe_reseau",
          label = "Exporter PNG",
          style = paste0("background:#008C45;color:white;padding:6px 14px;",
    ...
    output$node_info_panel <- shiny::renderUI({
      ...
      if (is.null(node_id) || identical(node_id, "null")) return(NULL)
      ...
      bd_color   <- if (is_company) "#008C45" else "#F4C300"

      edges_sel <- nd$edges[nd$edges$from == node_id | nd$edges$to == node_id, ]
      ...
      shiny::div(
        style = paste0(
          "background:", bg_color, ";border:1px solid ", bd_color, ";",
