...
\begin{titlepage}
  \begin{center}
    ...
    \begin{minipage}{0.45\textwidth}
      \centering
      \includegraphics[height=3.2cm]{ensae.png}\\[0.05cm]
...
\begin{itemize}
  \item les livrables analytiques majeurs sont \textbf{réalisés}, qu'il
...
\begin{itemize}
  ...
  \item des compétences \textbf{techniques} en R (traitement de données,
  ...
  réseaux et en \LaTeX{} ;
  \item des compétences \textbf{sectorielles} sur la Norme ITIE 2023, la
  ...
  modélisation FARI ;
  \item des compétences \textbf{professionnelles}, du travail en binôme et en
...
\begin{enumerate}
  \item \textbf{Fiabiliser la chaîne de collecte du RBE}, par un formulaire à
  ...
  Landfolio ;
  \item \textbf{Pérenniser et institutionnaliser OpenRBE}, en assurant
  ...
  \item \textbf{Renforcer la statistique du sous-secteur EMAPE}, avec une base
