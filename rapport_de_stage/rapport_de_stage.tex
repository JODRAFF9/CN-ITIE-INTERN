...
\begin{titlepage}
  \begin{center}
    ...
    {\color{ensaeblue}\Huge\bfseries\scshape Rapport de stage}\\[0.55cm]
    {\large Appui à la gestion des données du secteur extractif}\\[0.2cm]
    {\large Fiabilisation du Registre des Bénéficiaires Effectifs et analyse
